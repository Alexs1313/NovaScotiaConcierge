...
import {APP_ABOUT_TEXT} from '../../NovaScotiaConciergeData/NovaScotiaConciergeAssist/NovaScotiaConciergeAssist';
      ...
      <ScrollView
        ...
        <View style={styles.novaScotiaConciergeBody}>
          <View style={styles.novaScotiaConciergeBranding}>
            <Image
              source={require('../../NovaScotiaConciergeAssets/NovaScotiaConciergeAppMark.png')}
