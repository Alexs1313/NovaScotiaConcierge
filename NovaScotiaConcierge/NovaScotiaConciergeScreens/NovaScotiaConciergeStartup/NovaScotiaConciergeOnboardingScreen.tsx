...
import {OnboardingButtons} from '../../NovaScotiaConciergeComponents/NovaScotiaConciergeOnboarding/NovaScotiaConciergeOnboardingButtons';
import {ProgressDots} from '../../NovaScotiaConciergeComponents/NovaScotiaConciergeOnboarding/NovaScotiaConciergeProgressDots';
...
const STEPS = [
  {
    bg: require('../../NovaScotiaConciergeAssets/NovaScotiaConciergeWelcomeBackdrop1.png'),
    image: require('../../NovaScotiaConciergeAssets/NovaScotiaConciergeWelcomeIllustration1.png'),
    title: 'Your Resort Access',
    subtitle:
      'Keep your guest pass ready and open helpful resort tools from one elegant mobile guide.',
  },
  {
    bg: require('../../NovaScotiaConciergeAssets/NovaScotiaConciergeWelcomeBackdrop2.png'),
    image: require('../../NovaScotiaConciergeAssets/NovaScotiaConciergeWelcomeIllustration2.png'),
    title: 'Concierge Services',
    subtitle:
      'Request resort services, plan your visit, and prepare your stay with simple booking forms.',
  },
  {
    bg: require('../../NovaScotiaConciergeAssets/NovaScotiaConciergeWelcomeBackdrop3.png'),
    image: require('../../NovaScotiaConciergeAssets/NovaScotiaConciergeWelcomeIllustration3.png'),
    title: 'Events & Dining',
    subtitle:
      ...
      <ScrollView
        ...
        <View style={styles.novaScotiaConciergeLayout}>
          {step < STEPS.length - 1 ? (
            <View
              style={[
                styles.novaScotiaConciergeTopBar,
                {paddingTop: insets.top + 12},
              ]}>
              <Pressable
                style={styles.novaScotiaConciergeTopSkip}
                onPress={onComplete}>
          ...
          <View
            style={[
              styles.novaScotiaConciergeBottom,
