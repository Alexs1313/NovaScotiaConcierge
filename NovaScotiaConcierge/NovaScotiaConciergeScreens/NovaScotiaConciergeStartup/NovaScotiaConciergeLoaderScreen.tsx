...
export function LoaderScreen({onComplete}: Props) {
  ...
  useEffect(() => {
    novaScotiaConciergeDi.ensureGuestPassCode.execute();
  ...
  return (
    <ImageBackground
      source={require('../../NovaScotiaConciergeAssets/NovaScotiaConciergeSplashScene.png')}
      ...
      <View style={styles.novaScotiaConciergeContent}>
        <View style={styles.novaScotiaConciergeBranding}>
          <Image
            source={require('../../NovaScotiaConciergeAssets/NovaScotiaConciergeBrandLogo.png')}
