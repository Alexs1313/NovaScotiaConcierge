import type {FaqItem, ResortInfoSection} from '../types/assist';
...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'No. This app is designed as a guest access, concierge service, event planning, and dining order hub.',
  },
];
...
export const RESORT_INFO_INTRO =
  'Nova Scotia Casino Concierge helps guests organize access, services, events, dining requests, and useful resort information during their visit.';
...
export const RESORT_INFO_SECTIONS: ResortInfoSection[] = [
  {
    ...
    title: 'Guest Access',
    description:
      'Use your pass code when access or verification is requested.',
  },
  {
    id: 'services',
    icon: '🛎',
...
export const APP_ABOUT_TEXT =
  'Nova Scotia Casino Concierge is a guest information and planning app for pass access, concierge service booking, resort events, dining menu orders, guest tips, and visit organization.';
