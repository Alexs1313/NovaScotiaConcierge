...
export const EVENTS: ResortEvent[] = [
  ...
  },
  {
    ...
    usefulNote: 'Weekend buffet times may be popular, so arrive with extra time.',
  },
  {
  ...
  },
  {
    ...
    about:
      'A relaxed golf simulator session for guests who want to try a skill-based indoor activity. Suitable for beginners and experienced players, this event brings a light sport element into the resort visit.',
    usefulNote:
  ...
  {
    id: 'players-club-info',
    title: 'Players Club Info Moment',
    tag: 'Guest Info',
    time: '5:00 PM',
    date: 'Friday, June 5',
    dayOfWeek: 'Friday',
    ...
    dressMood: 'Casual',
    about:
      'A short information moment where guests can learn about the Players Club, available benefits, special offers, and how guest loyalty features work across the Nova Scotia destinations.',
    usefulNote:
      'Bring a valid ID if you plan to ask about membership details.',
  },
  {
