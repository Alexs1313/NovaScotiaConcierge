import type {
  FaqItem,
  ResortInfoSection,
} from '../../../NovaScotiaConcierge/NovaScotiaConciergeTypes/NovaScotiaConciergeAssist/NovaScotiaConciergeAssist';
...
export const APP_ABOUT_TEXT =
  'Nova Scotia Concierge Casino is a guest information and planning app for pass access, concierge service booking, resort events, dining menu orders, guest tips, and visit organization.';
